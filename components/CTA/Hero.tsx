    ...
    return (
        <>
            <div className='flex flex-col md:items-center gap-2 max-w-3xl mx-auto my-16 px-4'>
                ...
                <p className='text-gray-600 text-lg md:text-center'>
                    {tagline}
                </p>
                <div className='flex flex-col sm:flex-row mt-2 gap-2'>
                    ...
                    <button
                        className='group flex gap-2 items-center justify-center min-w-[10rem] text-center px-8 py-2 sm:py-3 text-lg text-gray-800 border rounded border-transparent hover:border-red-900 focus:outline-none focus:ring'
                        onClick={() => {
                            setLoginModal(true);
                        }}
                    >
